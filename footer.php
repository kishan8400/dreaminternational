                    ...
                    <div class="footer__widget mb-30">
                        ...
                        <div class="footer__widget-content">
                            <div class="footer__logo-area">
                                ...
                                <div class="social">
                                    <ul>
                                    <li><a href="https://www.youtube.com/@dreaminternational7604/" target="_blank"><i class="fab fa-youtube"></i></a></li>
                                        <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                        <li><a href="#"><i class="fab fa-twitter"></i></a></li>
                                       
                                        <li><a href="https://www.instagram.com/_dreaminternational_/" target="_blank"><i class="fab fa-instagram"></i></a></li>
                    ...
                    <div class="footer-widget mb-30">
                        ...
                        <div class="footer__services ">
                            <ul>
                                ...
                                <li><span> Sun - Thu :    9:30 AM - 7:30 PM</span> </li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="row align-items-center">
            <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-6">
                <div class="footer__text">
                    <p>Copyright ©2022 Dream International. All Rights Reserved</p>
                </div>
            </div>
                ...
                <div class="footer-copyright__wrapper footer-copyright__wrapper2">
                    <div class="footer-call d-flex align-items-center">
                        ...
                        <div class="footer-copyright__wrapper__call-number">
                            ...
                            <h5><a href="tel:7404031634">+91 7404 031 634</a></h5>
                        </div>
                    </div>
                </div>
            </div>
